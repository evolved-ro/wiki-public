...
### Locatie si Pregatire

* **Locatie:** Langa padurea de langa muntele **Chiliad** vei gasi o cabana speciala.
* **Echipament Obligatoriu:** Ai nevoie de o **arma speciala** (o poti procura de la business-ul din cabana).
* **Echipament Optional:** Poti cumpara si un **fluier** (Whistle) ca sa-ti usurezi munca.
...
Pentru a vana, iti trebuie o arma speciala, pe care o cumperi de la business-ul din cabana.

> [!WARNING]
> Aceasta arma este destinata **doar pentru vanatoare**. Nu vei putea provoca damage altor jucatori cu ea, asa ca poti s-o folosesti linistit in zona de vanatoare.
