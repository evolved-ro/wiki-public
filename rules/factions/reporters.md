...
| Abatere | Detalii |
| :--- | :--- |
| **Anunt Aiurea** | Daca anuntul este total aiurea (Ex: `/news am gresit ba, scuze`). |
| **Anunt Interzis** | Vanzare `rent`, materiale, droguri, inchirieri, targuri, **promovarea altor factiuni** (Ex: X ofera licente). |
| **Emoticoane/Prescurtari** | Folosirea oricarui tip de emoticon sau prescurtare intr-un anunt/interviu. |
| **Anunt Personal** | Plasarea unui anunt personal (Ex: Vanzare/Cumparare). |
| **Anunt Afara AG** | Orice anunt (in afara de cele gratuite) in intervalul **x:50 - x:59**. |
| **Anunt in Interviu** | Orice tip de anunt plasat in timpul unui interviu live. |
| **Anunt Prea Devreme** | Orice tip de anunt plasat in intervalul **x:00 - x:02**. |
| **Omisiune Numar Tel.** | Omiterea numarului de telefon intr-un anunt (in special la AG). |
